...
public class FundamentalsMethodsProject {
    ...
    static String formateazaCard(String nume, int puncte) {
        return "Nume: " + nume + " | Puncte: " + puncte;
    }

    static void printRaport(String nume, int puncte, double valPunct) {
        System.out.println(formateazaCard(nume, puncte));
        System.out.println("Valoare: " + convertToMoney(puncte, valPunct) + " lei | Bonus: " + calculeazaBonus(puncte));
    }


    public static void main (String[] args){
        printRaport("Ana", 120, 0.05);
    }
